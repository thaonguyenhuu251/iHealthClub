package com.htnguyen.ihealthclub.view.mainscreen.photoeditor.tools
...
class EmojiBSFragment : BottomSheetDialogFragment() {
    ...
    inner class EmojiAdapter : RecyclerView.Adapter<EmojiAdapter.ViewHolder>() {
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
            val view =
                LayoutInflater.from(parent.context).inflate(R.layout.item_row_emoji, parent, false)
    ...
    companion object {
        ...
        private fun convertEmoji(emoji: String): String {
            return try {
                ...
                return String(Character.toChars(convertEmojiToInt))
