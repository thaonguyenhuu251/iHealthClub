...
public class StoryView extends DialogFragment implements StoriesProgressView.StoriesListener,
    ...
    private ArrayList<ObjectStory> storiesList = new ArrayList<>();
    ...
    private void readArguments() {
        ...
        storiesList = new ArrayList<>((ArrayList<ObjectStory>) getArguments().getSerializable(IMAGES_KEY));
    ...
    private void updateHeading() {
        ...
        Date date = new Date(storiesList.get(counter).getCreateAt());

        Date dateNow = new Date();

        long diff = dateNow.getTime() - date.getTime();//as given
    ...
    public static class Builder {
        ...
        public Builder setStoriesList(ArrayList<ObjectStory> storiesList) {
